...
import torch
from .soft_attention import Attention_block
...
class ConvNextUNet(nn.Module):
    def __init__(self, num_classes=1, in_channels=3, dims=[96, 192, 384, 768]):
        super(ConvNextUNet, self).__init__()
        self.x00_down = Inception_Block(3, [16, 16, 16])  # channels=36  [4, 4, 4]  224 64
