...
try:
    from kernel.selective_scan import selective_scan_fn as selective_scan_fn_v1
...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=3, num_classes=2, depths=[2, 2, 2, 2], 
        ...
        self.SBA1 = Fusion(96)
        self.SBA2 = Fusion(192)
        self.SBA3 = Fusion(384)
    ...
    def forward(self, x, feature):
        ...
        x_downsample[0] = self.SBA1(feature[0],x_downsample[0].permute(0, 3, 1, 2)).permute(0, 2, 3, 1)
        x_downsample[1] = self.SBA2(feature[1],x_downsample[1].permute(0, 3, 1, 2)).permute(0, 2, 3, 1)
        x_downsample[2] = self.SBA3(feature[2],x_downsample[2].permute(0, 3, 1, 2)).permute(0, 2, 3, 1)
...
if __name__ == "__main__":
    ...
    out, x_downsample = model(int1,int2)
    print(out.shape)
    print(x_downsample[0].shape)
    print(x_downsample[1].shape)
